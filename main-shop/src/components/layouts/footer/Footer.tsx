import {ImageView, LoginModal, Logo, RegisterModal} from "@/components";
        ...
        <footer className="container mb-[68px] relative">
            ...
            <div  className="mb-[68px]">
                <div
                    ...
                    <ImageView src={'/assets/images/Screenshot (76).png'} className={"absolute bottom-0 right-0 sm:h-full h-3/4"} alt={'banner'} width={587} height={331}/>
                </div>
            </div>
            <div className="flex flex-col md:flex-row justify-between flex-wrap gap-[16px] divide-y-2 md:divide-y-0 mb-[70px]">
                ...
                <div className="pt-4 md:pt-0">
                    <div className="flex text-heading6 md:text-heading5 lg:text-heading4 xl:text-heading4 text-blue-300 toggle">Company</div>
                ...
                <div className="pt-4 md:pt-0">
                    <div className="flex text-heading6 md:text-heading5 lg:text-heading4 xl:text-heading4 text-blue-300 toggle">Information</div>
                    <IconBox icon={"icon-down-dark inline-block sm:hidden"} size={24}/>
                    <ul className="hidden md:flex flex-col gap-2.5">
