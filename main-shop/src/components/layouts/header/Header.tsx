        ...
        <header className="mb-[33px]">
            <div className="container flex items-center justify-between py-4 md:py-6 xl:py-8">
                ...
                <ul className="hidden lg:flex gap-5">
                    ...
                    <li className="flex gap-2 cursor-pointer">
                        <IconBox icon={'icon-shopping-cart'} link={"#"} hideTitleOnMobile={true} title={'Card'} size={24} badge={0} />
                    ...
                    <div id="all_categories"
                        ...
                        <div id="all_categories_box"
                            ...
                            <div id="all_cat_inner_box" className="flex flex-wrap justify-between gap-y-[15px]">
                                ...
                                <Link href="#"
                                   className="flex items-center gap-3.5 rounded-[5px] lg:border-[1px] lg:border-gray-300 py-2.5 basis-[calc(50%-8px)] justify-start pl-4 lg:hover:border-green-300 cursor-pointer">
                                    <i className="icon-drinks-1 text-[30px]"><span className="path1"></span><span
                                        className="path2"></span><span className="path3"></span><span
                                        className="path4"></span><span className="path5"></span></i>
                                ...
                                <Link href="#"
                                   className="flex items-center gap-3.5 rounded-[5px] lg:border-[1px] lg:border-gray-300 py-2.5 basis-[calc(50%-8px)] justify-start pl-4 lg:hover:border-green-300 cursor-pointer">
                                    <i className="icon-dairy-products-1 text-[30px]"><span
                                ...
                                <Link href="#"
                                   className="flex items-center gap-3.5 rounded-[5px] lg:border-[1px] lg:border-gray-300 py-2.5 basis-[calc(50%-8px)] justify-start pl-4 lg:hover:border-green-300 cursor-pointer">
                                    <span className="icon-milk-products-1 text-[30px]"><span
                                        className="path1"></span><span className="path2"></span><span
                                        className="path3"></span><span className="path4"></span><span
