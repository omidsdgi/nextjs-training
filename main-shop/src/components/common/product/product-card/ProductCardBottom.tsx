                ...
                currentProductInBasket ?
                    <div
                        ...
                        <div className="flex flex-col justify-between">
                            ...
                            <IconBox icon={"down icon-angle-small-up"} onClick={()=>basket.decreaseItem(productData.id)} size={10}/>
                        </div>
                        {currentProductInBasket.quantity }
                    </div>
                    :
                    <button onClick={() => basket.addItem(productData)} className="flex items-center justify-center text-heading-sm text-green-200 border-[1px] rounded-[4px] bg-green-150 px-[10px] py-[5px]">Adds
                        +
                    </button>
            }
