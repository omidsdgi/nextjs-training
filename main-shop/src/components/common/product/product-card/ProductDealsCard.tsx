...
export function ProductDealsCard({data}: Props) {
    ...
    useEffect(() => {
        const interval=setInterval(()=>  {
            if(data.attributes.discount_expire_date){
    ...
    return (
        <div className="relative h-[438px] mt-52">
            <ImageView className="w-full" src={data.attributes.thumbnail?.data?.attributes.url} alt={"product"} width={378} height={325}/>
                ...
                <div className="bg-white mt-2.5 px-8 pt-6 pb-4 rounded-[10px] shadow-c-xs">
                    ...
                    <div className="flex items-center justify-between mt-3">
                        ...
                        <div className="add-product">
                            <button className="flex items-center justify-center text-heading-sm text-green-200 border-[1px] rounded-[4px] bg-green-150 px-[10px] py-[5px]">Adds
                                +
                            </button>
                            <div
