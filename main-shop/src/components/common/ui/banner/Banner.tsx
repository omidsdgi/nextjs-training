...
export function Banner({}: Props) {
    return (
        <>
            <div
                className="grid grid-cols-2 items-center rounded-lg bg-hero-pattern bg-[#FDC040] bg-opacity-20 bg-cover bg-no-repeat">
                ...
                <ImageView src="/assets/images/fresh-apples.png" className="m-w-[50%]" alt={'banner'} height={538} width={717}/>
            </div>
